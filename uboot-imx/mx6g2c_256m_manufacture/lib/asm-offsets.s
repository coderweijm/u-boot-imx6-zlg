...
@ -I ../arch/arm/include -I ../. -I . -imultilib .
@ -imultiarch arm-linux-gnueabihf
@ -iprefix /home/shenguiting/mx6g2c-crosstool/bin/../lib/gcc/arm-linux-gnueabihf/4.9.2/
@ -isysroot /home/shenguiting/mx6g2c-crosstool/bin/../arm-linux-gnueabihf/libc
@ -D __KERNEL__ -D __UBOOT__ -D CONFIG_SYS_TEXT_BASE=0x86800000 -D __ARM__
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /home/shenguiting/mx6g2c-crosstool/bin/../lib/gcc/arm-linux-gnueabihf/4.9.2/include
@ -include ../include/linux/kconfig.h -MD lib/.asm-offsets.s.d
@ ../lib/asm-offsets.c -marm -mno-thumb-interwork -mabi=aapcs-linux
@ -mword-relocations -mno-unaligned-access -mfloat-abi=hard -march=armv7-a
...
.LASF14:
	.ascii	"start\000"
.LASF58:
	.ascii	"/home/shenguiting/src/uboot-imx/mx6g2c_256m_manufac"
	.ascii	"ture\000"
.LASF38:
	.ascii	"name\000"
.LASF26:
...
.LASF56:
	...
	.ascii	"-unaligned-access -mfloat-abi=hard -march=armv7-a -"
	.ascii	"mtune=cortex-a9 -mfpu=vfpv3-d16 -mtls-dialect=gnu -"
	.ascii	"g -Os -fno-builtin -ffreestanding -fno-stack-protec"
	.ascii	"tor -fstack-usage -fno-pic -ffunction-sections -fda"
	.ascii	"ta-sections -fno-common -ffixed-r9\000"
.LASF47:
	.ascii	"next\000"
.LASF46:
