cmd_lib/libfdt/fdt_addresses.o := arm-linux-gnueabihf-gcc -Wp,-MD,lib/libfdt/.fdt_addresses.o.d  -nostdinc -isystem /home/shenguiting/mx6g2c-crosstool/bin/../lib/gcc/arm-linux-gnueabihf/4.9.2/include -Iinclude  -I../include -I../arch/arm/include -include ../include/linux/kconfig.h  -I../lib/libfdt -Ilib/libfdt -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x86800000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -mhard-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(fdt_addresses)"  -D"KBUILD_MODNAME=KBUILD_STR(fdt_addresses)" -c -o lib/libfdt/fdt_addresses.o ../lib/libfdt/fdt_addresses.c
...
deps_lib/libfdt/fdt_addresses.o := \
  ...
  /home/shenguiting/mx6g2c-crosstool/lib/gcc/arm-linux-gnueabihf/4.9.2/include/stddef.h \
  ...
  include/config.h \
    ...
    $(wildcard include/config/ddr/nand/256m.h) \
    $(wildcard include/config/manufacture.h) \
  ...
  ../include/configs/mx6g2c.h \
    ...
    $(wildcard include/config/board/1c.h) \
    ...
    $(wildcard include/config/netboot/env/setting.h) \
