cmd_board/freescale/mx6g2c/imximage.cfg.cfgtmp := arm-linux-gnueabihf-gcc -E -Wp,-MD,board/freescale/mx6g2c/.imximage.cfg.cfgtmp.d  -nostdinc -isystem /home/shenguiting/mx6g2c-crosstool/bin/../lib/gcc/arm-linux-gnueabihf/4.9.2/include -Iinclude  -I../include -I../arch/arm/include -include ../include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x86800000 -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -mhard-float -pipe -march=armv7-a -x c -o board/freescale/mx6g2c/imximage.cfg.cfgtmp ../board/freescale/mx6g2c/imximage.cfg

source_board/freescale/mx6g2c/imximage.cfg.cfgtmp := ../board/freescale/mx6g2c/imximage.cfg

deps_board/freescale/mx6g2c/imximage.cfg.cfgtmp := \
...
board/freescale/mx6g2c/imximage.cfg.cfgtmp: $(deps_board/freescale/mx6g2c/imximage.cfg.cfgtmp)
